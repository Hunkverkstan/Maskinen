                    ...
                    <div class="article-block-alt first-article" style="background-image:url('<?php echo esc_url($thumbnail_url); ?>')">
                        ...
                        <div class="article-block-info-alt">
                            ...
                            <div class="button-grp">
                                <button class="fourth-bg" onclick="location.href='<?php the_permalink(); ?>'">Läs artikel</button>
                            </div>
                        </div>
                    </div>
</div>
...
<div class="article-block-small-meta fourth-bg-tone fourth"><?php the_field('article_tag'); ?></div>
