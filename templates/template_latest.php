...
<div class="row">
<div class="segment-block bg1 text1 marg-medium"><i data-feather="star" class="marg-right-medium secondary"></i>Fler recensioner</div><h4 class="secondary" id="reviews-archive-link"><a class="no" href="<?php echo home_url(); ?>/recensioner">Till arkivet <i data-feather="arrow-right" class="secondary marg-left"></i></a></h4>
</div>
...
$args = array(
    ...
    'post__not_in' => $shown_post_ids, // Exclude the current post
...
if ($query->have_posts()) : 
    ...
    while ($query->have_posts()) : $query->the_post(); 
        ...
        ?>
        <a href="<?php the_permalink(); ?>" class="silent review-block-small bg1">
