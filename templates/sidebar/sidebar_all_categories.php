<div class="block">
<div class="segment-block bg1 text1 marg-medium"><span class="secondary">•</span> Utforska alla stadsdelar</div>
...
<div class="block-info secondary-bg-tone">
    ...
    foreach ($categories as $category) {
        ...
        echo '<h5 class="row block-link text1"><a class="no" href="' . $category_link . '">' . $category_name . '</a> <span class="block-link-meta text3">' . $post_count_label . '</span></h5>';
    }
    ?>
</div>
</div>