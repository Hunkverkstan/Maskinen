...
<p class="breadcrumb x-small text2"><a href="<?php echo home_url(); ?>">Hem</a> > <a href="<?php echo home_url(); ?>/artiklar">Artiklar</a> > <?php the_title(); ?></p>
</div>
<div id="content-img" class="marg-medium" style="background-image:url(<?php echo get_the_post_thumbnail_url( $post, 'full' ); ?>)">
<div id="content-location" class="bg1 third"><?php the_field('article_tag'); ?></div>
</div>
...
<?php include ('templates/template_latest_articles.php'); ?>
</div>
