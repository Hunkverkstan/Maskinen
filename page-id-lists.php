...
<div id="pages-archive">
    ...
    <div class="block">
        <div class="row"><div class="segment-block bg1 text1 marg-medium">Senaste listan</div>
        </div>
<div class="flex">    
<?php
...
<div class="block-info-alt bg2 marg-medium">
            ...
            echo do_shortcode('[ajax_load_more container_type="div" id="reviews" preloaded="true" preloaded_amount="8" post_type="listor" posts_per_page="5" filters_analytics="false" button_label="Ladda fler artiklar" button_loading_label="Laddar artiklar ..." button_done_label="Slut på listor" exclude="' . $post_id . '"]');
            ?>
 </div>
    </div>
</div>
